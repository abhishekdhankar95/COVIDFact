...
classifier_pickle = 'models/covid_classifier_rbf_87.p'
predict_text_filename = 'data/zindi/updated_test.csv' # this is the filw which should have text csv to be classified
